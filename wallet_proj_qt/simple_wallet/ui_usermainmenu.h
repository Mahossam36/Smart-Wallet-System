...
""));
        ...
        label_3->setGeometry(QRect(190, 90, 721, 471));
        label_3->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"border-radius: 30px;         /* rounded corners */\n"
"    padding: 8px 16px;"));
        logoutbutton = new QPushButton(usermainmenu);
        logoutbutton->setObjectName("logoutbutton");
        logoutbutton->setGeometry(QRect(560, 410, 331, 131));
        QFont font;
...
"}"));
        QIcon icon;
        icon.addFile(QString::fromUtf8("deleteuser.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        editprofilebutton->setGeometry(QRect(560, 110, 331, 131));
...
"}"));
        ...
        sendmoneybutton = new QPushButton(usermainmenu);
        sendmoneybutton->setObjectName("sendmoneybutton");
        sendmoneybutton->setGeometry(QRect(210, 260, 331, 131));
        sendmoneybutton->setFont(font);
        sendmoneybutton->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    background-color: #cddce8;   /* light blue */\n"
"    color: black;\n"
"    border: none;                /* no border line */\n"
"    border-radius: 12px;         /* rounded corners */\n"
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("sendmoneyicon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        sendmoneybutton->setIcon(icon2);
        sendmoneybutton->setIconSize(QSize(80, 80));
        sendmoneybutton->setAutoDefault(true);
        sendmoneybutton->setFlat(true);
        requestmoneybutton = new QPushButton(usermainmenu);
        requestmoneybutton->setObjectName("requestmoneybutton");
        requestmoneybutton->setGeometry(QRect(560, 260, 331, 131));
...
"}"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("requestmoneyicon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        transactionhistorybutton->setGeometry(QRect(210, 410, 331, 131));
...
"}"));
        ...
        balancebutton->setGeometry(QRect(210, 110, 331, 131));
...
"}"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("moneyicon.jpg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        backButton = new QPushButton(usermainmenu);
        backButton->setObjectName("backButton");
        backButton->setGeometry(QRect(30, 578, 111, 41));
...
""));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("logouticon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        backButton->setIcon(icon6);
    ...
    void retranslateUi(QDialog *usermainmenu)
    {
        ...
        logoutbutton->setText(QCoreApplication::translate("usermainmenu", "Delete Account", nullptr));
        editprofilebutton->setText(QCoreApplication::translate("usermainmenu", "Edit Profile", nullptr));
        sendmoneybutton->setText(QCoreApplication::translate("usermainmenu", "Send Money", nullptr));
        requestmoneybutton->setText(QCoreApplication::translate("usermainmenu", "Request Money", nullptr));
        ...
        backButton->setText(QCoreApplication::translate("usermainmenu", "  Logout", nullptr));
    } // retranslateUi
